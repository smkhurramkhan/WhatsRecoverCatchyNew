...
import com.catchyapps.whatsdelete.databinding.FragmentEidStickersBinding
import timber.log.Timber


class EidStickersFragment : Fragment() {
   private lateinit var binding : FragmentEidStickersBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEidStickersBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        stickersList = MyAppDataUtils.loadStickersSingleList(requireActivity().assets, "Eid")
        setUpStickersRV()
    }
