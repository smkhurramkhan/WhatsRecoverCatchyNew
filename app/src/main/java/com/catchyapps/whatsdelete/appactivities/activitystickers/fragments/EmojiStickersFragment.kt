...
import com.catchyapps.whatsdelete.databinding.FragmentEmojiStickersBinding
import timber.log.Timber

class EmojiStickersFragment : Fragment() {
  private lateinit var binding: FragmentEmojiStickersBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEmojiStickersBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        stickersList = MyAppDataUtils.loadStickersSingleList(requireActivity().assets, "Emoji")
        setUpStickersRV()
    }
