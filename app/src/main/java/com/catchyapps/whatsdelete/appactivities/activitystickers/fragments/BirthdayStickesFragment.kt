...
import com.catchyapps.whatsdelete.databinding.FragmentBirthdayStickesBinding
import timber.log.Timber

class BirthdayStickesFragment : Fragment() {
  lateinit var binding : FragmentBirthdayStickesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBirthdayStickesBinding.inflate(layoutInflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        stickersList = MyAppDataUtils.loadStickersSingleList(requireActivity().assets, "Birthday")
        setUpStickersRV()
    }
